...
- "foo"
    ...
    expected = s(:block, s(:lasgn, :_buf, s(:array)), s(:call, s(:lvar, :_buf), :<<, s(:call, s(:str, "<p></p>"), :freeze)), s(:call, s(:lvar, :_buf), :<<, s(:call, s(:colon2, s(:colon3, :Temple), :Utils), :escape_html, s(:call, s(:lit, 1), :/, s(:lit, 0)))), s(:str, "foo"), s(:lasgn, :_buf, s(:call, s(:lvar, :_buf), :join, s(:call, s(:str, ""), :freeze))))
